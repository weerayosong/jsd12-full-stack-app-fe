            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-0.5">
                ...
                <div className="flex gap-2">
                    <select
                        ...
                        onChange={onChange}
                        className="flex-1 bg-slate-50 border border-gray-200 text-sm px-3 py-0.5 rounded-sm focus:outline-none focus:border-slate-400 text-slate-600"
                    >
                    ...
                    {editId ? (
                        ...
                        <button
                            type="submit"
                            className="bg-slate-800 hover:bg-slate-700 text-white px-4 py-0.5 rounded-sm text-sm font-bold transition-colors cursor-pointer"
                        >
                            Post
                        </button>
                    )}
